...
import styles from "./HaveFunThemesPage.module.css";
  ...
  return (
    <div className={styles.container}>
      <Slideshow
        ...
        viewAllLink="/have-fun/category/trending-memes"
      />
      <Slideshow
        title="Trending Memecoins"
        assets={mostTradedAssets}
        viewAllLink="/have-fun/collections/most-traded-memecoins"
      />
      <Slideshow
        title="Community Favorites"
        assets={communityFavorites}
        viewAllLink="/have-fun/collections/community-favorites"
      />
      <Slideshow
        title="Explore Metas"
        assets={exploreMetas}
        viewAllLink="/have-fun/collections/explore-metas"
      />
    </div>
  );
};
